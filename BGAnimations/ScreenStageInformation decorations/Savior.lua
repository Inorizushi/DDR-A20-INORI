...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor("es/cr_rinon")..{
		InitCommand=cmd(diffusealpha,0;x,SCREEN_CENTER_X-25;y,SCREEN_CENTER_Y-2;sleep,0.767;diffusealpha,0.1;linear,1.5;addx,25;diffusealpha,1;linear,0.267;addx,4;diffusealpha,0.1;sleep,0;diffusealpha,0);
	};
	LoadActor("es/ring")..{
