return Def.ActorFrame {
	...
	Def.Sprite {
		OnCommand=function(self)
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'3.25x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x3_25_P1"));        
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'3.75x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x3_75_P1"));        
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'4.25x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x4_25_P1"));         
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'4.75x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x4_75_P1"));         
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'5.25x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x5_25_P1"));        
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'5.75x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x5_75_P1"));        
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'6.25x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x6_25_P1"));         
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'6.75x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x6_75_P1"));        
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'7.25x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x7_25_P1"));        
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'7.75x') then
				self:Load(THEME:GetPathB("","optionicon_P1/speed_x7_75_P1"));        
	...
	Def.Sprite {
		InitCommand=function(self)
			...
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'3 lives,battery') then			
				self:Load(THEME:GetPathB("","optionicon_P1/life_3_P1"));
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'2 lives,battery') then			
				self:Load(THEME:GetPathB("","optionicon_P1/life_2_P1"));
			elseif GAMESTATE:PlayerIsUsingModifier(PLAYER_1,'1 life,battery') then			
				self:Load(THEME:GetPathB("","optionicon_P1/life_1_P1"));                                			
			end;
		end;
		PlayerJoinedMessageCommand=function(self, params)
			if params.Player == PLAYER_1 then
