...
t[#t+1] = LoadFont("_helvetica-condensed-light 24px")..{
		...
		JudgmentMessageCommand=function(self, param)
			if param.Player == PLAYER_1 then
				if param.TapNoteScore == 'TapNoteScore_W1' or param.TapNoteScore == 'TapNoteScore_W5' or param.TapNoteScore == 'TapNoteScore_Miss' or param.TapNoteScore == 'TapNoteScore_HitMine' or param.TapNoteScore == 'TapNoteScore_AvoidMine' or param.HoldNoteScore then 
				else
					if param.Early then
