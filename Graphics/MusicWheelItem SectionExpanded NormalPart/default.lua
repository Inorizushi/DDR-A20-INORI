return Def.ActorFrame {
	...
	--DefaultBG
	Def.Sprite{
		Texture=THEME:GetPathG("MusicWheelItem","SectionCollapsed NormalPart/"..ddrgame.."00di_folder.png"),
		InitCommand=function(s) s:y(-8) end,
	};
	Def.Sprite{
		Texture=ddrgame.."00di_folder_on",
		InitCommand=function(s) s:y(-8) end,
	};
	Def.Sprite{
		Texture=THEME:GetPathG("MusicWheelItem","SectionCollapsed NormalPart/"..ddrgame.."00di_folder_y.png"),
		InitCommand=function(s) s:y(-8) end,
		SetMessageCommand=function(self,params)
			if params.HasFocus then
				self:zoom(1)
